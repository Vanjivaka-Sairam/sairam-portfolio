  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white">
      <div id="about" className="text-center mt-20">
        ...
        <a href="/assets/your-cv.pdf" download className="mt-6 px-10 py-4 bg-blue-500 text-white text-lg font-semibold rounded-full hover:bg-blue-600 hover:shadow-lg transition-transform transform hover:scale-105">Download CV</a>
      </div>
    </div>
  );
};
